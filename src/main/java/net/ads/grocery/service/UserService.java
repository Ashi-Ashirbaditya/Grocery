...
import net.ads.grocery.model.Role;
import net.ads.grocery.model.User;
import net.ads.grocery.repository.UserRepository;
...
@Service
public class UserService implements UserDetailsService {   // ✅ implements interface
